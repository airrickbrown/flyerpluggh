...
export function App() {
  ...
  const portfolioItems = [
    {
      ...
      desc: "Modern food flyer for a local chop bar"
    },
    {
      id: 2,
      category: "Events",
      title: "Wedding Invitation",
      image: "https://picsum.photos/id/133/600/800",
      desc: "Elegant wedding announcement flyer"
    },
    {
      id: 3,
      category: "Birthday",
      ...
      desc: "Vibrant birthday celebration design"
    },
    {
      id: 4,
      category: "Music",
      ...
      desc: "Hip hop concert promotional flyer"
    },
    {
      id: 5,
      category: "Church",
      ...
      desc: "Church revival announcement"
    },
    {
      id: 6,
      category: "Business",
      ...
      desc: "Beauty salon launch flyer"
    },
  ];
  ...
  const testimonials = [
    {
      name: "Kwame Mensah",
      role: "Owner, Koko's Kitchen",
      text: "Got my menu flyer designed in under 2 hours. Looks very professional and my sales increased! Highly recommend.",
      avatar: "https://picsum.photos/id/64/128/128"
    },
    {
      name: "Ama Serwaa",
      role: "Afrobeats Artist",
      text: "The flyer for my single launch was fire! Got so many streams from the design. Fast and creative.",
      avatar: "https://picsum.photos/id/65/128/128"
    },
    {
      name: "Yaw Boateng",
      role: "Event Promoter",
      text: "Used them for 3 different events this year. Always on time and the designs always pop. Best in Ghana.",
  ...
  const faqs = [
    {
      ...
      a: "Most flyers are delivered within 30 minutes to 2 hours after you provide the details. Rush orders available."
    },
    {
      q: "What details do I need to send?",
      a: "Just send your business name or event details, colors you prefer, key information (date, time, location), and any logos or images you want included."
    },
    {
      q: "Can I request changes?",
      a: "Yes! You get 2 rounds of revisions included with every order. We want you to be 100% satisfied."
    },
    {
      q: "Do you design for all businesses and events?",
      a: "Absolutely. From small businesses, churches, parties, birthdays, music events, to personal brands and more."
    },
    {
      q: "How do I pay?",
      a: "We accept Mobile Money (MTN, Vodafone, AirtelTigo), bank transfers, and PayPal for international clients."
    },
  ];
        ...
        <div className="max-w-screen-2xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button 
              ...
              className="flex items-center gap-2 px-5 py-2.5 text-sm border border-white/30 hover:border-orange-400 rounded-2xl transition-all hover:text-orange-400"
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-black px-8 py-2.5 rounded-2xl font-semibold text-sm transition-all active:scale-[0.985]"
            >
              ORDER NOW
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-zinc-950 border-t border-white/10 px-6 py-8 flex flex-col gap-6 text-lg">
            ...
            <div className="pt-6 border-t border-white/10 flex flex-col gap-4">
              <button 
                onClick={openInstagram}
                className="flex items-center justify-center gap-3 py-4 border border-white/30 rounded-3xl"
              >
                <Instagram className="w-5 h-5" /> Follow on Instagram
              </button>
              <button 
                onClick={openWhatsApp}
                className="py-4 bg-orange-500 text-black font-semibold rounded-3xl flex items-center justify-center gap-2"
              >
        ...
        <div className="max-w-screen-2xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                onClick={openWhatsApp}
                className="group flex items-center gap-3 bg-white text-black px-9 py-4 rounded-3xl font-semibold text-lg hover:bg-amber-200 transition-all active:scale-95 shadow-xl shadow-orange-500/20"
              >
                ORDER ON WHATSAPP
              ...
              <button 
                ...
                className="flex items-center gap-3 border border-white/40 hover:bg-white/5 px-8 py-4 rounded-3xl font-medium transition-all"
              >
                VIEW OUR WORK
              </button>
            </div>
          ...
          {[
            {
              ...
              desc: "Most designs delivered in under 90 minutes. Perfect for last minute events."
            },
            {
              icon: "🎨",
              title: "Premium Quality",
              desc: "Clean, modern and bold designs that stand out in the feed and on the street."
            },
            {
              icon: "💰",
              title: "Unbeatable Price",
              desc: "Professional designs for only GH₵30. No hidden fees. No surprises."
            },
            {
              icon: "🌍",
              title: "Ghana Focused",
              desc: "We understand the Ghanaian market, culture and what makes our people stop scrolling."
            }
          ].map((feature, index) => (
      ...
      <section id="portfolio" className="bg-zinc-900 py-20">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <div className="mt-16 text-center">
            <button 
              onClick={openWhatsApp}
              className="mx-auto border border-white/30 px-8 py-4 rounded-3xl text-sm inline-flex items-center gap-3 hover:border-orange-400 group"
            >
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5">
            <div className="sticky top-28">
              ...
              <p className="text-zinc-400 mt-6 text-lg max-w-sm">
                Everything you need to promote your business, event or brand in style.
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, idx) => (
            <div key={idx} className="bg-zinc-900 rounded-3xl p-8 border border-white/5">
              ...
              <div className="mt-8 text-lg leading-tight text-zinc-300">
                “{testimonial.text}”
              </div>
          ...
          {[
            {
              ...
              desc: "Send a WhatsApp message with your event or business name, details, preferred colors and any reference images."
            },
            {
              num: "02",
              title: "We get to work",
              desc: "Our designer creates a beautiful custom flyer based on your brief. You'll get a preview within the hour."
            },
            {
              num: "03",
              title: "Approve & receive",
              desc: "Review the design. Request changes if needed. Once you're happy, we send you the final high quality files."
            }
          ].map((step, index) => (
      ...
      <section className="bg-black py-24 border-t border-white/10">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
            <button 
              onClick={openWhatsApp}
              className="flex-1 sm:flex-none bg-white text-black py-5 px-14 rounded-3xl font-semibold text-lg flex items-center justify-center gap-3 hover:bg-amber-100"
            >
            ...
            <button 
              onClick={openInstagram}
              className="flex-1 sm:flex-none border border-white/60 py-5 px-10 rounded-3xl font-medium flex items-center justify-center gap-2 hover:bg-white/5"
            >
      ...
      <footer className="bg-black border-t border-white/10 py-16">
        <div className="max-w-screen-2xl mx-auto px-6 grid md:grid-cols-12 gap-y-12">
          <div className="md:col-span-5">
            ...
            <div className="mt-6 text-zinc-400 max-w-xs">
              Fast, clean and professional flyer designs for the modern Ghanaian entrepreneur.
            </div>
            
            <div className="mt-8 text-xs text-zinc-500">© {new Date().getFullYear()} Flyer Plug GH. All rights reserved.</div>
          </div>
